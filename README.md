...
Ripple Music is a music streaming application with an interactive audio player component using React, JSX, and JavaScript. Application has landing, library, and album pages.
